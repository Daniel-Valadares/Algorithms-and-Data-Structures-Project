...
public class Menu {
    ...
    private static void lerPadraoNome() {
        String tmp;
        System.out.print("Qual padrão deseja procurar? ");
        tmp = sc.nextLine();
        System.out.println("");
        System.out.println("Mostrando todos os elementos com padrão achado:");
        System.out.println("");
        System.out.println("ID | Nome | [Emails] | Nome de Usuario | Senha | CPF | Cidade | N. Transferências | Saldo");
        System.out.println("");
        ContaDAO.readPatternNome(tmp);
        System.out.println("");
        System.out.println("Obs: Caso nenhum registro tenha sido mostrado, o padrão não existe em nome");
        System.out.println("");
        enter();
    }

    private static void lerPadraoCidade() {
        String tmp;
        System.out.print("Qual padrão deseja procurar? ");
        tmp = sc.nextLine();
        System.out.println("");
        ...
        System.out.println("ID | Nome | [Emails] | Nome de Usuario | Senha | CPF | Cidade | N. Transferências | Saldo");
        System.out.println("");
        ContaDAO.readPatternCidade(tmp);
        System.out.println("");
        System.out.println("Obs: Caso nenhum registro tenha sido mostrado, o padrão não existe em cidade");
        System.out.println("");
        enter();
    }
    ...
    private static void menuLeitura() {
        ...
        do {
            ...
            System.out.println(" [6] Ler todos os registros que contem determinado padrão em nome (KMP)");
            System.out.println(" [7] Ler todos os registros que contem determinado padrão em cidade (KMP)");
    ...
    private static void lerRegistro() {
        ...
        int id;
        // 
        System.out.print("Descriptografar Senha? [Y/n]: ");
        tmp = sc.nextLine();
        System.out.println("");
        if (tmp.contains("n") || tmp.contains("N")) {
            do {
            ...
            do {
                ...
                c = ContaDAO.readDescriptografado(id);
            } while (!isIdFound(c.getIdConta()));
        }
    ...
    private static void mostrarRegistro() {
        String tmp;
        System.out.print("Descriptografar Senhas? [Y/n]: ");
        tmp = sc.nextLine();
        System.out.println("");
        if (tmp.contains("n") || tmp.contains("N")) {
            ...
            System.out.println("ID | Nome | [Emails] | Nome de Usuario | Senha | CPF | Cidade | N. Transferências | Saldo");
            System.out.println("");
            ContaDAO.showAllDescriptografado();
            System.out.println("");
        }
        enter();
    }
    ...
    private static void inserirTest() {
        // preparar emails
    ...
    public static void metodosCompress() {
        // Paths para uso junto com debugger do vscode
        LZW lzw = new LZW("data/contas.db");
        Huffman huffman = new Huffman("data/contas.db");
        // Paths para uso de compilação manual
        //LZW lzw = new LZW("../data/contas.db");
        //Huffman huffman = new Huffman("../data/contas.db");

        // Compressao LZW
        System.out.println("=======================================");
        System.out.println("Método LZW:");
        System.out.println("=======================================");
        ...
        System.out.println("Tempo de Compressão: " + end + "ms");

        // Tempo de descompactação
        start = System.currentTimeMillis();
        try {
            lzw.decompress("contas");
        } catch (IOException e) {
            System.out.println(e.getMessage());
        }
        end = System.currentTimeMillis() - start;
        System.out.println("Tempo de Descompressão: " + end + "ms");
        System.out.println("");
        System.out.println("Bytes do arquivo original = " + lzw.getNumBytesOriginal());
        System.out.println("Bytes do arquivo compactado = " + lzw.getNumBytesComp());
        System.out.println("Bytes do arquivo descompactado = " + lzw.getNumBytesDescomp());
        System.out.println("");
        // Calculo do percentual de redução
        float taxaCompressao = (float)lzw.getNumBytesComp() / (float)lzw.getNumBytesOriginal();
        float percentualReducao = 100*(1-taxaCompressao);
        System.out.println("Taxa de Compressão: " + taxaCompressao);
        System.out.println("Percentual de Redução: " + percentualReducao + "%");
        System.out.println("");
        System.out.println("Obs: O arquivo descompressado foi salvo na pasta dados como contas.dblzw");
        System.out.println("");
        ...
        // Compressao Huffman
        System.out.println("=======================================");
        System.out.println("Método Huffman:");
        System.out.println("=======================================");
        // Tempo de compactação
        start = System.currentTimeMillis();
        huffman.compressao();
        ...
        System.out.println("");
        System.out.println("Bytes do arquivo original = " + huffman.getNumBytesOriginal());
        System.out.println("Bytes do arquivo compactado = " + huffman.getNumBytesComp());
        System.out.println("Bytes do arquivo descompactado = " + huffman.getNumBytesDescomp());
        System.out.println("");
        // Calculo do percentual de redução
        taxaCompressao = (float)huffman.getNumBytesComp() / (float)huffman.getNumBytesOriginal();
        percentualReducao = 100*(1-taxaCompressao);
        System.out.println("Taxa de Compressão: " + taxaCompressao);
        System.out.println("Percentual de Redução: " + percentualReducao + "%");
        System.out.println("");
        System.out.println("Obs: O arquivo descompressado foi salvo na pasta dados como contas.dblzw");
    ...
    public static void start() {
        ...
        do {
            ...
            System.out.println(" [8] Inserir contas de teste");
            System.out.println(" [9] Compactar e descompactar arquivos");
    ...
    public static void end() {
        // dados
        //String tmp;
        ContaDAO.endAll();// finalizar metodos chamados pela DAO
        System.out.println("======================================================================");
